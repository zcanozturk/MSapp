...
import 'package:MSapp/core/network/network_helper.dart';
import 'package:MSapp/view/login/model/login_model.dart';
import 'package:MSapp/view/login/model/login_response_model.dart';
...
class LoginService extends ILoginService with NetworkHelper {
  ...
  Future<LoginResponseModel?> sendLoginRequest(LoginModel model) async {
    final response = await networkManager.send<LoginResponseModel,
            LoginResponseModel>(
        ApplicationConstants.appAuthURL + '/your-login-path',
